...
class EmployerProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var postedWorksButton = view.findViewById<AppCompatButton>(R.id.postedWorksButton)
        ...
        postedWorksButton.setOnClickListener{
            ...
            employerCvsFragment.arguments = bundle
            transaction?.replace(R.id.fragmentContainer, employerCvsFragment)?.addToBackStack(null)
            transaction?.commit()
